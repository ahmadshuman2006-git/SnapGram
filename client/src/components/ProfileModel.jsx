          ...
          >
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    ...
                    alt=""
                    className="
                    w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2"
                  />
                  <div
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                ...
                rounded-lg text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer"
              >
                Cancel
              </button>
